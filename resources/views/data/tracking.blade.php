    ...
    <div class="col-lg-11 col-lg-offset-1" id="test">
          <div class="box box-success">
              ...
              <div class="box-body">
                    ...
                    {!! Form::open(['method'=> 'post','url' => 'store_invoice', 'files' => true ]) !!}
             ...
             @foreach(explode(";",$data->payment_list) as $p2 )
              ...
              @endif
                             ...
                             <div class="form-group col-md-2">
                                {{ Form::label('name', 'Checker') }}
                                {{ Form::text('reviewer',$data->checker, array('class' => 'form-control input-sm','readonly')) }}
                            </div>
                            ...
                            <div class="row">
                                 <div class="form-group col-md-4">
                                {{ Form::label('name', 'Agent Authorization Letter') }}
                             <!--    <input type="file" multiple="" name="payment_list[]" class="form-control input-sm"> -->
                             <div class="form-control">
                                @if(!empty($data->agent_pdf))
            
              <a href="{{url('view-letter/'.$data->agent_pdf)}}"  target="_blank" class="label label-sm label-default"><i class="fa fa-paperclip" aria-hidden="true"></i> {{$data->agent_pdf}}</a>
