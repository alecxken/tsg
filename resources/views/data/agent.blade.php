        ...
        <div class="box-body">    
          ...
          <div class="form-group  center">
           ...
           <div class="form-group  center">
             ...
             {!!Form::email('email',Null,['class' => 'form-control' ,'maxlength'=>'155'])!!}
          </div>

           <div class="form-group  center">
             {!! Form::label('weight', 'Phone ', ['class' => 'awesome'])!!}
             {!!Form::number('phone',Null,['class' => 'form-control' ,'maxlength'=>'55'])!!}
          </div>
           ...
           <div class="form-group  center">
             ...
             {!!Form::text('contract',Null,['class' => 'form-control' ,'maxlength'=>'155'])!!}
          </div>

           <div class="form-group  center">
             {!! Form::label('weight', 'Physical Address ', ['class' => 'awesome'])!!}
             {!!Form::textarea('phy_address',Null,['class' => 'form-control' ,'rows'=>'3'])!!}
          </div>
